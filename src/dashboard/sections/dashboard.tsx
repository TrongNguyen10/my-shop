...
const Dashboard: React.FC = () => {
    ...
    const filterByPrice = (price: string, arr: any) => {
        ...
        if (price == "price-normal") {
            filteredProducts.sort(function (a: any, b: any) {
                return a.id - b.id;
            });
        } else {
            if (price == "price-asc") {
    ...
    const filterByPriceRange = (minPrice: any, maxPrice: any, arr: any) => {
        ...
        filteredProducts =
            arr || (!!searchValue ? searchedProducts : categoryProducts);
    ...
    return (
        <div style={{ height: "100%" }}>
            ...
            <Routes>
                <Route
                    path="/"
                    element={<DashboardBody {...dashboardBodyProps} />}
                />
                <Route
                    path="/product/:title"
                    element={<ProductInfo addToCart={handleAddToCart} />}
                />
            </Routes>
            <Footer />
        </div>
